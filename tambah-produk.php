...
<head>
    ...
    <title>Add Product-NoInscure | E-Commerce </title>
        ...
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="harga" placeholder="Masukkan Harga Produk" class="input-control" required>
                    <input type="file" name="gambar" class="input-control" required>
                    <textarea name="deskripsi" class="input-control" placeholder="Masukkan Deskripsi Produk"></textarea><br>
